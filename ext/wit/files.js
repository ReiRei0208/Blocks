(function (Scratch) {
    ...
    if (!Scratch.extensions.unsandboxed) {
        throw new Error('文件扩展必须运行在非沙盒环境中');
    }
    ...
    class FilesZH {
        ...
        setOpenMode(args) {
            if (ALL_MODES.includes(args.mode)) {
                ...
                console.warn(`未知模式：`, args.mode);
            }
        }
    }

    Scratch.extensions.register(new FilesZH());
})(Scratch);